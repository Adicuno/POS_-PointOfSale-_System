package com.filflo.repository;

import com.filflo.modal.Order;
import com.filflo.modal.User;
import com.filflo.payload.StoreAnalysis.BranchSalesDTO;
import com.filflo.payload.StoreAnalysis.PaymentInsightDTO;
import com.filflo.payload.StoreAnalysis.TimeSeriesPointDTO;
...
""")
    ...
    @Query("""
    SELECT new com.filflo.payload.StoreAnalysis.TimeSeriesPointDTO(
        o.createdAt,
        SUM(o.totalAmount)
    )
    FROM Order o
...
""")
    ...
    @Query("""
        SELECT new com.filflo.payload.StoreAnalysis.PaymentInsightDTO(
            o.paymentType,
            SUM(o.totalAmount)
        )
        FROM Order o
    ...
    """)
        ...
        @Query("""
        SELECT new com.filflo.payload.StoreAnalysis.BranchSalesDTO(
            o.branch.name,
            SUM(o.totalAmount)
        )
        FROM Order o
