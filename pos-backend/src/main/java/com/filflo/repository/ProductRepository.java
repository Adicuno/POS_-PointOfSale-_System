...
import com.filflo.payload.StoreAnalysis.CategorySalesDTO;
...
// store analysis
    ...
    @Query("""
        SELECT new com.filflo.payload.StoreAnalysis.CategorySalesDTO(
            p.category.name,
    ...
    @Query("""
        SELECT new com.filflo.payload.dto.ProductDTO(
                p.id,
                p.name,
                p.sku,
                p.description,
