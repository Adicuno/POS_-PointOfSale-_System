...
public interface UserRepository extends JpaRepository<User, Long> {
	...
	List<User> findByStoreAndRoleIn(com.filflo.modal.Store store, List<UserRole> roles);
	List<User> findByBranchAndRoleIn(com.filflo.modal.Branch branch, List<UserRole> roles);
...
int countByStoreAdminIdAndRoles(@Param("storeAdminId") Long storeAdminId,
	...
	@Query("""
    SELECT new com.filflo.payload.dto.UserDTO(
		u.id,
		u.email,
    ...
    AND u.role = com.filflo.domain.UserRole.ROLE_BRANCH_CASHIER
""")
